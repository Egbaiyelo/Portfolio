...
export default async function Home({
  ...
  return (
    <div>
      ...
      <section className='text-white border-t border-white/10 pt-12 m-4'>
        ...
        <div className='grid grid-cols-12 w-full gap-0 border border-white/10 rounded-xl overflow-hidden grid-flow-row-dense'>
          ...
          <div className='col-span-4 p-8 row-span-2 '>
            <Image src={"/canada-ontario.png"} alt='' width={400} height={400} className='mx-auto my-auto' />
          </div>
...
{/* //+ each tile should link to relevant sections */}
          <div className='flex col-span-6 border-r border-white/10 p-8'>
